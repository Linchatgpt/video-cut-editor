...
export default function App() {
  ...
  useEffect(() => {
    if (selectedClip && playingClipId === selectedClip.id && videoRef.current) {
      videoRef.current.volume = Number(selectedClip.originalVolume ?? 1);
